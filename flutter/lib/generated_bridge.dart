...
class RustdeskImplImpl implements RustdeskImpl {
  final RustdeskImplPlatform _platform;
  factory RustdeskImplImpl(ExternalLibrary dylib) =>
      RustdeskImplImpl.raw(RustdeskImplPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory RustdeskImplImpl.wasm(FutureOr<WasmModule> module) =>
      RustdeskImplImpl(module as ExternalLibrary);
  RustdeskImplImpl.raw(this._platform);
  Stream<String> startGlobalEventStream(
      {required String appType, dynamic hint}) {
...
class RustdeskImplPlatform extends FlutterRustBridgeBase<RustdeskImplWire> {
  RustdeskImplPlatform(ffi.DynamicLibrary dylib)
      : super(RustdeskImplWire(dylib));
...
class RustdeskImplWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  RustdeskImplWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  RustdeskImplWire.fromLookup(
